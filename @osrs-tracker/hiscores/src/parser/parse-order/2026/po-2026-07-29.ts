...
export const PO_2026_07_29: ParseOrder = [
  SkillEnum.Overall,
  SkillEnum.Attack,
  SkillEnum.Defence,
  SkillEnum.Strength,
  ...
  ActivityEnum.MadAngel,
  ActivityEnum.MaggotKing,
  ActivityEnum.Mimic,
  ActivityEnum.Nex,
